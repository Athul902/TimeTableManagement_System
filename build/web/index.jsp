...
<html lang="en">
    ...
    <body>
        <div class="navbar">
            ...
            <button class="logout-button" id="AdminLogin">Admin</button>
        </div>
        <div class="form-container">
            <form action="showTimetable.jsp" method="post"> <!-- Use GET to pass course as a parameter -->
            ...
            <script>
                const superAdminLogin = document.getElementById("AdminLogin");

                superAdminLogin.addEventListener("click", () => {
                    window.location.href = "AdminLogin.html"; // Redirect to index1.html
                });
            </script>
        </div>
    </body>
